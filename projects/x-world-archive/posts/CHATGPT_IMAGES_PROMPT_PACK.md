...
2. paste the prompt
3. if possible, add the previous image for continuity-sensitive prompts
4. generate 4 to 8 options
5. keep only the most authored result
